...
<div><h1>디테일 페이지</h1></div>
	...
	<a href="${context}/board.do?action=list"><input type="submit" class="btn btn-primary" style="float:right;width:100px;margin-right:10px" value="LIST"/></a>
	<a href="${context}/board.do?action=update"><input type="submit" class="btn btn-warning" style="float:right;width:100px;margin-right:10px" value="UPDATE"/></a>
</div>
